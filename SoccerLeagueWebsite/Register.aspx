...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" Runat="Server">
    <form runat="server">
    <asp:createuserwizard runat="server" OnCreatedUser="Unnamed1_CreatedUser" ID="ctl00" Font-Bold="True" Font-Size="X-Large"> 
            <WizardSteps> 
                <asp:CreateUserWizardStep runat="server"> 
                    <ContentTemplate>
                        <table style="font-size:100%;font-weight:bold;">
                            <tr>
